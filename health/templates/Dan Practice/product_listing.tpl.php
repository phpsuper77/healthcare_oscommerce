      ...
      for ($col=0, $n=sizeof($column_list); $col<$n; $col++) {
        ...
        switch ($column_list[$col]) {
          case 'PRODUCT_LIST_MODEL':
            $lc_text = '<tr><td class="productModelCell paddingLR">' . highlight_text($listing['products_model'], $search_keywords) . '</td></tr>';
            break;
          ...
          case 'PRODUCT_LIST_BUY_NOW':
            if ( $this->view_button ) {
              ...
              $lc_text = '<tr><td class="productButtonCell paddingLR"><a href="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $listing['products_id']) . '">' . tep_template_image_button('button_buy_now.' . BUTTON_IMAGE_TYPE, IMAGE_BUTTON_BUY_NOW, 'class="transpng"') . '</a></td></tr>';
            }
