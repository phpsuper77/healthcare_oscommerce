          ...
          <tr>
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2" class="contentBoxContents">
              <tr>
                ...
                <td class="main" width="50%" valign="top"><?php echo TEXT_CHOOSE_SHIPPING_DESTINATION . '<br><br><a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . tep_template_image_button('button_change_address.' . BUTTON_IMAGE_TYPE, IMAGE_BUTTON_CHANGE_ADDRESS, 'class="transpng"') . '</a>'; ?></td>
...
<?php
  $contents = array();
  $contents[] = array('text' => TABLE_HEADING_SHIPPING_METHOD);
  new contentBoxHeading($contents);
?>
        <table border="0" width="100%" cellspacing="1" cellpadding="0" class="contentBox">
          <tr>
