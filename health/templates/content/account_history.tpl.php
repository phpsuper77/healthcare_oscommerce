...
<?php
  ...
  $info_box_contents[] = array('text' => '<table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td class="main"><b>' . TEXT_ORDER_NUMBER . '</b> ' . $history['orders_id'] .'</td><td align="right" class="main"><b>' . TEXT_ORDER_STATUS . '</b> ' . $history['orders_status_name'] .'</td></tr></table>');
            ...
            <tr>
              <td><table border="0" width="100%" cellspacing="2" cellpadding="4" class="contentBoxContents">
                <tr>
                  ...
                  <td class="main" width="20%"><?php echo '<a href="' . tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, (isset($HTTP_GET_VARS['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . 'order_id=' . $history['orders_id'], 'SSL') . '">' . tep_template_image_button('small_view.' . BUTTON_IMAGE_TYPE, SMALL_IMAGE_BUTTON_VIEW, 'class="transpng"') . '</a>'; ?></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
<?php
  ...
  $info_box_contents[] = array(array('text' => tep_draw_separator('pixel_trans.gif', '10', '1')),
                               array('params' => 'class="main" align="right" width=100%', 'text' => '<a href="' . tep_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">' . tep_template_image_button('button_back.' . BUTTON_IMAGE_TYPE, IMAGE_BUTTON_BACK, 'class="transpng"') . '</a>'),
