...
<?php
  $contents = array();
  $contents[] = array('text' => TABLE_HEADING_SHIPPING_ADDRESS);
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2" class="contentBoxContents">
              <tr>
                ...
                <td align="right" width="50%" valign="top"><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main" align="center" valign="top"><?php echo '<b>' . TITLE_SHIPPING_ADDRESS . '</b><br>' . tep_image(DIR_WS_TEMPLATE_IMAGES . 'arrow_south_east.gif'); ?></td>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
...
<?php
  $contents = array();
  $contents[] = array('text' => TABLE_HEADING_NEW_SHIPPING_ADDRESS);
  new contentBoxHeading($contents);
?>
        <table border="0" width="100%" cellspacing="1" cellpadding="0" class="contentBox">
          <tr>
...
<?php
  ...
  $info_box_contents[] = array(array('text' => tep_draw_separator('pixel_trans.gif', '10', '1')),
                               ...
                               array('params' => 'align=right', 'text' => tep_draw_hidden_field('action', 'submit') . tep_template_image_submit('button_continue.' . BUTTON_IMAGE_TYPE, IMAGE_BUTTON_CONTINUE, 'class="transpng"')),
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td class="main" align="right"><?php echo tep_draw_hidden_field('action', 'submit') . tep_template_image_submit('button_continue.' . BUTTON_IMAGE_TYPE, IMAGE_BUTTON_CONTINUE, 'class="transpng"'); ?></td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table></td>
          </tr>
...
?> 
      <tr>
        <td><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . tep_template_image_button('button_back.' . BUTTON_IMAGE_TYPE, IMAGE_BUTTON_BACK, 'class="transpng"') . '</a>'; ?></td>
      </tr>
<?php
  }
?>
