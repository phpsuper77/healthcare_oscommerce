...
<?php
  ...
  $info_box_contents[] = array('text' => PRIMARY_ADDRESS_TITLE);
            ...
            <td><table border="0" cellspacing="2" cellpadding="2" class="contentBoxContents" width="100%" height="100%">  
              <tr>
                ...
                <td align="right" width="50%" valign="top"><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main" align="center" valign="top"><b><?php echo PRIMARY_ADDRESS_TITLE; ?></b><br><?php echo tep_image(DIR_WS_TEMPLATE_IMAGES . 'arrow_south_east.gif'); ?></td>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
...
<?php
  $info_box_contents = array();
  $info_box_contents[] = array('text' => ADDRESS_BOOK_TITLE);
              ...
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr class="moduleRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onClick="document.location.href='<?php echo tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL'); ?>'">
                    ...
                    <td class="main" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL') . '">' . tep_template_image_button('small_edit.'  . BUTTON_IMAGE_TYPE, SMALL_IMAGE_BUTTON_EDIT, 'class="transpng"') . '</a> <a href="' . tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $addresses['address_book_id'], 'SSL') . '">' . tep_template_image_button('small_delete.' . BUTTON_IMAGE_TYPE, SMALL_IMAGE_BUTTON_DELETE, 'class="transpng"') . '</a>'; ?></td>
                  </tr>
                  <tr>
...
if (tep_count_customer_address_book_entries() < MAX_ADDRESS_BOOK_ENTRIES) {
   $addr = '<a href="' . tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, '', 'SSL') . '">' . tep_template_image_button('button_add_address.' . BUTTON_IMAGE_TYPE, IMAGE_BUTTON_ADD_ADDRESS, 'class="transpng"') . '</a>';
  }
  $info_box_contents = array();
  $info_box_contents[] = array(array('text' => tep_draw_separator('pixel_trans.gif', '10', '1')),
                               ...
                               array('params' => 'class="smallText" align="right"', 'text' => $addr),
