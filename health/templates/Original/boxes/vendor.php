<?php
/*
$Id: vendor.php,v 1.1.1.1 2005/12/03 21:36:13 max Exp $
...
if (is_file(DIR_FS_CATALOG . '/' . DIR_WS_TEMPLATE_IMAGES . 'infoboxheading/' . $infobox_id . '_' . $languages_id . '.jpg')){
  ...
  $info_box_contents = array();
  $info_box_contents[] = array('text'  => BOX_HEADING_VENDOR);
...
$info_box_contents = array();
$info_box_contents[] = array('text' => '<a class="infoBoxLink" href="' . tep_href_link(FILENAME_VENDOR_INFO). '">' . BOX_VENDOR_INFO . '</a><br>' .
'<a class="infoBoxLink" href="' . tep_href_link(FILENAME_VENDOR_SIGNUP, '', 'SSL') . '">' . BOX_VENDOR_LOGIN . '</a>');
