...
<!-- information //-->
<?php
if (tep_banner_exists('dynamic', 'right01') || tep_banner_exists('dynamic', 'right02') || tep_banner_exists('dynamic', 'right03') || tep_banner_exists('dynamic', 'right04')){
?>
<tr>
...
<?php
  ...
  if ($banner = tep_banner_exists('dynamic', 'right01')) {
