...
/*
  ...
  $info_box_contents[] = array('form' => tep_draw_form('quick_find', tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false), 'get'),
                               'align' => 'center',
                               'text' => $param . tep_draw_input_field('keywords', '', 'size="10" maxlength="30" style="width: 100px"') . '&nbsp;' . tep_hide_session_id() . tep_template_image_submit('button_quick_find.' . BUTTON_IMAGE_TYPE, BOX_HEADING_SEARCH, 'class="transpng"') . '<br>' . BOX_SEARCH_TEXT . '<br><a class="infoBoxLink" href="' . tep_href_link(FILENAME_ADVANCED_SEARCH) . '"><b>' . BOX_SEARCH_ADVANCED_SEARCH . '</b></a>');
