...
// BOF: attribute options
    ...
    if ($products_attributes == '1') {
      ...
      while ($products_options_name_values = tep_db_fetch_array($products_options_name)) {
        ...
        echo '<tr><td class="main">' . htmlspecialchars($products_options_name_values['products_options_name']) . ':</td><td>' . "\n";
        ...
        while ($products_options_values = tep_db_fetch_array($products_options)) {
          $products_options_array[] = array('id' => $products_options_values['products_options_values_id'], 'text' => htmlspecialchars($products_options_values['products_options_values_name']));
