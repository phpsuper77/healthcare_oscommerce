<?php
/*
  $Id: geo_zones.php,v 1.1.1.1 2005/12/03 21:36:01 max Exp $
...
<?
  ...
  if (isset($HTTP_GET_VARS['zone'])) $header_title_submenu='<span class="smallText">' . tep_get_geo_zone_name($HTTP_GET_VARS['zone']) . '</span>';
?>
