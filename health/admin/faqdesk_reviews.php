		...
		<td class="main" valign="top">
		  <table border="0" width="100%" cellspacing="0" cellpadding="2">
		    <tr>
		      ...
		      <td class="main"><?php echo $rInfo->faqdesk_question; ?></td>
		    </tr>
		    <tr>
		    ...
		    <tr>
		      ...
		      <td class="main"><?php echo tep_date_short($rInfo->date_added); ?></td>
		    </tr>
		    <tr>
		      <td class="main"><b><?php echo ENTRY_FROM; ?></b></td>
		      <td class="main"><?php echo $rInfo->customers_name; ?></td>
		    ...
		    <tr>
		      <td class="main" colspan="2"><b><?php echo ENTRY_REVIEW; ?></b></td>
		    </tr>
		    <tr>
		      <td class="main" colspan="2"><?php echo tep_draw_textarea_field('reviews_text', 'soft', '60', '15', $rInfo->reviews_text); ?></td>
		    </tr>
      	<tr>
      		<td class="smallText" align="right" colspan="2"><?php echo ENTRY_REVIEW_TEXT; ?></td>
      	</tr>
      	 <tr>
		      <td class="main"><b><?php echo ENTRY_RATING; ?></b></td>
		      <td class="main"><?php echo TEXT_BAD; ?>&nbsp;<?php for ($i=1; $i<=5; $i++) echo tep_draw_radio_field('reviews_rating', $i, '', $rInfo->reviews_rating) . '&nbsp;'; echo TEXT_GOOD; ?></td>
		    </tr>
		    <tr>
...
<?php echo ENTRY_RATING; ?>
		...
		&nbsp;
<?php echo tep_image(DIR_WS_TEMPLATE_IMAGES . 'reviews/stars_' . $rInfo->reviews_rating . '.gif', sprintf(TEXT_OF_5_STARS, $rInfo->reviews_rating)); ?>
		&nbsp;
		<small>[
...
<?php echo '<a href="' . tep_href_link(FILENAME_FAQDESK_REVIEWS, 'page=' . $HTTP_GET_VARS['page'] . '&rID=' . $reviews['reviews_id'] . '&action=preview') . '">' . tep_image(DIR_WS_ICONS . 'preview.gif', ICON_PREVIEW) . '</a>&nbsp;' . faqdesk_get_products_name($reviews['faqdesk_id']); ?>
		...
		<td class="dataTableContent" align="right"><?php echo tep_image(DIR_WS_TEMPLATE_IMAGES . 'reviews/stars_' . $reviews['reviews_rating'] . '.gif'); ?>
		</td>
