...
if ($HTTP_GET_VARS['action'] == 'edit') {
	...
	$rInfo_array = array_merge($reviews, $products_name);
...
<?php echo '<a href="' . tep_href_link(FILENAME_NEWSDESK_REVIEWS, 'page=' . $HTTP_GET_VARS['page'] . '&rID=' . $reviews['reviews_id'] . '&action=preview') . '">' . tep_image(DIR_WS_ICONS . 'preview.gif', ICON_PREVIEW) . '</a>&nbsp;' . tep_get_description_field(TABLE_NEWSDESK_DESCRIPTION, 'newsdesk_article_name', 'newsdesk_id', $reviews['newsdesk_id']) ; ?>
		</td>
