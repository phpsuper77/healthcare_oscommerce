...
<tr class="dataTableHeadingRow">
	<td align="center" class="dataTableHeadingContent" width="30"><?php echo NO_INFORMATION;?></td>
...
<?php  echo tep_image(DIR_WS_ICONS . 'sort.gif', SORT_BY); ?>
	...
	<td align=center class="dataTableHeadingContent" <?php if (!tep_session_is_registered('login_affiliate')) echo 'colspan="2"';?>><?php echo ACTION_INFORMATION;?></td>
...
?>
   <tr bgcolor="<?php echo $bgcolor?>">
    ...
    <td align="center" nowrap  class="dataTableContent">
<?php 
if ($val[visible]==1) {
  echo tep_image(DIR_WS_ICONS . 'icon_status_green.gif', IMAGE_ICON_STATUS_GREEN, 10, 10) . 
       (!tep_session_is_registered('login_affiliate')?
          '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_INFORMATION_MANAGER, "adgrafics_information=Visible&information_id={$val['information_id']}&visible={$val['visible']}") . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_red_light.gif', DEACTIVATION_ID_INFORMATION . " {$val['information_id']}", 10, 10) . '</a>':
          '');
}else {
  echo tep_image(DIR_WS_ICONS . 'icon_status_red.gif', IMAGE_ICON_STATUS_RED, 10, 10) . 
       (!tep_session_is_registered('login_affiliate')?
          '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_INFORMATION_MANAGER, "adgrafics_information=Visible&information_id={$val['information_id']}&visible={$val['visible']}") . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_green_light.gif', ACTIVATION_ID_INFORMATION . " {$val['information_id']}", 10, 10) . '</a>':
          '');
};
?>
</td>
