<?php
/*
  $Id: link_categories.php,v 1.1.1.1 2005/12/03 21:36:01 max Exp $
  ...
  if (tep_not_null($action)) {
    switch ($action) {
      ...
      default:
        ...
        if (is_array($link_categories) && is_array($links_count)) $cInfo_array = array_merge($link_categories, $links_count);
...
<?
  ...
  $header_title_additional=tep_draw_form('search', FILENAME_LINK_CATEGORIES, '', 'get').HEADING_TITLE_SEARCH . ' ' . tep_draw_input_field('search').'</form>';
?>
