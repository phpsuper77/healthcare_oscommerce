<?php
/*
  $Id: infobox_configuration.php,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
define('TABLE_HEADING_FONT_COLOR', 'Font Colour');
...
define('TEXT_HEADING_IMAGES', 'Heading Images');
