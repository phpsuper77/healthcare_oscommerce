<?php
/*
  $Id: login.php,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
define('AFFILIATE_EMAIL_TEXT', 'Hi %s,' . "\n\n" . 'You can access the affiliate panel with the following password. Once you access the affiliate, please change your password!' . "\n\n" . 'Website : %s' . "\n" . 'Username: %s' . "\n" . 'Password: %s' . "\n\n" . 'Thanks!' . "\n" . '%s' . "\n\n" . 'This is an automated response, please do not reply!'); 
define('VENDOR_EMAIL_TEXT', 'Hi %s,' . "\n\n" . 'You can access the vendor panel with the following password. Once you access the vendor, please change your password!' . "\n\n" . 'Website : %s' . "\n" . 'Username: %s' . "\n" . 'Password: %s' . "\n\n" . 'Thanks!' . "\n" . '%s' . "\n\n" . 'This is an automated response, please do not reply!'); 
