...
define('HEADING_TITLE', 'Category and News Management');
...
define('TEXT_NEWSDESK_META_TITLE', 'Page title:');
define('TEXT_NEWSDESK_META_DESCRIPTION', 'Description meta-tag:');
define('TEXT_NEWSDESK_META_KEY', 'Keywords:');  
?>
