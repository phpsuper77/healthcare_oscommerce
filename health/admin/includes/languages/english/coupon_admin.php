<?php
/*
  $Id: coupon_admin.php,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
define('TEXT_VISIT', 'when you visit ' . tep_get_clickable_link(HTTP_SERVER . DIR_WS_CATALOG));
...
define('TEXT_EMAIL_COUPON', 'E-mail coupon');
define('TEXT_EDIT_COUPON', 'Edit coupon');
define('TEXT_DELETE_COUPON', 'Delete coupon');
define('TEXT_COUPON_REPORT', 'Coupon Report');
define('ERROR_NO_COUPON_AMOUNT', 'Coupon amount error.');
define('ERROR_COUPON_EXISTS', 'Coupon with this code already exists.');
