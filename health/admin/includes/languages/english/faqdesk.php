...
define('HEADING_TITLE', 'Category and FAQ Management');
...
define('TEXT_FAQDESK_SORTORDER','Sort order:');

define('TEXT_FAQDESK_META_TITLE', 'Page title:');
define('TEXT_FAQDESK_META_DESCRIPTION', 'Description meta-tag:');
define('TEXT_FAQDESK_META_KEY', 'Keywords:');
?>