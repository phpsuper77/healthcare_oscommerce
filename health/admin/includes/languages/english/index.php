<?php
/*
  $Id: index.php,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
define('TEXT_CURRENT_TIME','Current time');
define('TEXT_EVERYDAY_ACTIVITIES','Everyday activities');
define('TEXT_SITE_MANAGEMENT','Site management');
