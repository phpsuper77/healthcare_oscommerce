...
define('HEADING_TITLE', 'Vendor Summary');
define('TEXT_SUMMARY_TITLE', 'Vendor Summary');
define('TEXT_IMPRESSIONS', 'Total Banner Impressions: ');
define('TEXT_VISITS', 'Total Affiliate Visits: ');
define('TEXT_TRANSACTIONS', 'Total Vendor Transactions: ');
define('TEXT_VENDOR', 'Number of Vendors: ');
define('TEXT_CONVERSION', 'Conversion: ');
define('TEXT_AMOUNT', 'Total Vendors Sales: ');
define('TEXT_AVERAGE', 'Average Vendors Payout/Sale: ');
...
define('GREET_MR', 'Dear Mr. ');
define('GREET_MS', 'Dear Ms. ');
define('GREET_NONE', 'Dear '); 
define('TEXT_VENDOR_NUMBER', 'Your vendor number');
?>
