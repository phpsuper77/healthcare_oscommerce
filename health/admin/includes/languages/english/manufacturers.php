<?php
/*
  $Id: manufacturers.php,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
define('TEXT_REMOVE_IMAGE', 'Remove manufacturers image?');
...
// SEO Manufacturers
define('TEXT_MANUFACTURERS_META_DESCRIPTION', 'Description meta-tag:');
define('TEXT_MANUFACTURERS_META_KEYWORDS', 'Keywords meta-tag:');
define('TEXT_MANUFACTURERS_META_TITLE', 'Title meta-tag:');
define('TEXT_MANUFACTURERS_SEO_NAME', 'Manufacturers SEO name:');
