<?php
/*
  $Id: template_configuration.php,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
define('TEXT_COLUMN_LEFT_WIDTH', 'Set the left column width');
define('TEXT_COLUMN_RIGHT_WIDTH', 'Set the right column width');
