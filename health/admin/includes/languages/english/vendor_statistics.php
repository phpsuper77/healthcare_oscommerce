<?php
/*
  $Id: vendor_statistics.php,v 1.1.1.1 2005/12/03 21:36:05 max Exp $
...
define('HEADING_TITLE', 'Vendor Statistics');
define('TEXT_SUMMARY_TITLE', 'Vendor Statistics');
define('TEXT_IMPRESSIONS', 'Total Banner Impressions: ');
define('TEXT_VISITS', 'Total Vendor Visits: ');
define('TEXT_TRANSACTIONS', 'Total Vendor Transactions: ');
define('TEXT_VENDOR_NAME', 'Name of Vendor: ');
define('TEXT_VENDOR_JOINDATE', 'Date Vendor Joined: ');
define('TEXT_CONVERSION', 'Conversion: ');
define('TEXT_AMOUNT', 'Total Vendor Sales: ');
define('TEXT_AVERAGE', 'Average Vendor Payout/Sale: ');
