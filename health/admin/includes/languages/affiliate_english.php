<?php
/*
  $Id: affiliate_english.php,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
define('BOX_AFFILIATE_DEFINE_AFFILIATE_INFO', 'Define Affiliate info page');
define('BOX_AFFILIATE_DEFINE_AFFILIATE_TERMS', 'Define Affiliate terms page');
?>