<?php
/*
  $Id: index.php,v 1.1.1.1 2005/12/03 21:36:05 max Exp $
...
define('TEXT_CURRENT_TIME','Datum');
define('TEXT_EVERYDAY_ACTIVITIES','Tägliche Aktivitäten');
define('TEXT_SITE_MANAGEMENT','Seitenmanagert');
define('TEXT_CONFIGURATION','Konfiguration');
