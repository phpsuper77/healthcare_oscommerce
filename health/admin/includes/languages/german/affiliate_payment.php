<?php
/*
  $Id: affiliate_payment.php,v 1.1.1.1 2005/12/03 21:36:05 max Exp $
...
define('IMAGE_AFFILIATE_BILLING', 'Rechnungs-Engine startene');
...
define('TEXT_AFFILIATE_HEADER', 'Ihre Kommissionsverg&uuml;tungen:');

define('TABLE_HEADING_DATE', 'Datum');
define('TABLE_HEADING_PAYMENT', 'Kommissionsverg&uuml;tung');
define('TABLE_HEADING_STATUS', 'Status');
define('TABLE_HEADING_PAYMENT_ID','Lfd-Nr.');
define('TEXT_DISPLAY_NUMBER_OF_PAYMENTS', 'Kommissionsverg&uuml;tungen <b>%d</b> bis <b>%d</b> (von <b>%d</b> insgesamt)');
define('TEXT_INFORMATION_PAYMENT_TOTAL', 'Ihre Gesamtkommissionsverg&uuml;tungen bisher:');
define('TEXT_NO_PAYMENTS', 'Bis jetzt wurden noch keine Kommissionsverg&uuml;tungszahlungen registriert.');
