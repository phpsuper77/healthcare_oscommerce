<?php
/* $Id: upsell_products.php,v 1.1.1.1 2005/12/03 21:36:05 max Exp $
...
define('UP_SELL_SUCCESS', 'Produkt ID ' . $_GET['add_related_product_ID'] . ' mit ihren Empfehlungen wurde erfolgreich aktualisiert.');
define('SORT_UP_SELL_SUCCESS', 'Sortierreihenfolge für die empfohlenen Artikel sind für das Hauptprodukt ' .$_GET['add_related_product_ID'] . ' aktuallisiert worden.');

/* define('UP_SELL_SUCCESS', 'Cross Sell Items Successfully Update For Cross Sell Product #'.$_GET['add_related_product_ID']);
define('SORT_UP_SELL_SUCCESS', 'Sort Order Successfully Update For Cross Sell Product #'.$_GET['add_related_product_ID']);
*/
...
define('TABLE_HEADING_UP_SELL_THIS', 'Diesen Artikel zum verkauften Hauptprodukt empfehlen?');
...
define('TEXT_UP_SELL', 'Artikelempfehlung');
?>
