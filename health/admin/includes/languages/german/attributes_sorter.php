...
define('TEXT_COPY_ATTRIBUTES_ONLY','Dies wird nur f&uuml;r wiederholte Produkte benutzt ...');
define('TEXT_COPY_ATTRIBUTES','Produktattribute duplizieren?');
...
define('TABLE_HEADING_OPTION_SORT_ORDER','Betsellung sortieren');
?>
