<?php
/*
  $Id: vendor_summary.php,v 1.1.1.1 2005/12/03 21:36:05 max Exp $
...
define('HEADING_TITLE', 'Lieferantenprogramm &Uuml;bersicht');

define('TEXT_SUMMARY_TITLE', 'Zusammenfassung und &Uuml;bersicht zum Lieferantenprogramm');
define('TEXT_IMPRESSIONS', 'Banner Impressionen: ');
define('TEXT_VISITS', 'Besuche &uuml;ber Lieferantenseiten: ');
define('TEXT_TRANSACTIONS', 'Lieferanten Verk&auml;ufe: ');
define('TEXT_VENDOR', 'Gesamtzahl der Lieferanten: ');
...
define('IMAGE_BANNERS','Lieferanten Banner');
define('IMAGE_CLICKTHROUGHS','Bericht &uuml;ber Klicks');
define('IMAGE_SALES','Bericht &uuml;ber Verk&auml;ufe');
define('GREET_MR', 'Sehr geehrter Herr ');
define('GREET_MS', 'Sehr geehrte Frau ');
define('GREET_NONE', 'Sehr geehrte ');
define('TEXT_VENDOR_NUMBER', 'Ihre Lieferantennummer');
?>