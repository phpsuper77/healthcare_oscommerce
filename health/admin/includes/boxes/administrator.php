<?php
/*
  $Id: administrator.php,v 1.1.1.1 2005/12/03 21:36:03 max Exp $
...
<?php
  ...
  $heading[] = array('text'  => BOX_HEADING_ADMINISTRATOR,
                     'link'  => tep_href_link(tep_selected_file('administrator.php', FILENAME_ADMIN_MEMBERS), tep_get_all_get_params(array('selected_box')) . 'selected_box=administrator'));
