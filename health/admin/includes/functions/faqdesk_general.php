...
// -----------------------------------------------------------------------
function faqdesk_get_faqdesk_meta($product_id, $language_id) {
$product_query = tep_db_query("select faqdesk_article_meta_title, faqdesk_article_meta_description, faqdesk_article_meta_key from " . TABLE_FAQDESK_DESCRIPTION . " where faqdesk_id = '" . $product_id . "' and language_id = '" . $language_id . "'");
$product = tep_db_fetch_array($product_query);

$arr_return = array('meta_title' => $product['faqdesk_article_meta_title'],
             'meta_description' => $product['faqdesk_article_meta_description'],
						 'meta_key' => $product['faqdesk_article_meta_key']);
