<?php
/*
  $Id: affiliate_functions.php,v 1.1.1.1 2005/12/03 21:36:03 max Exp $
...
/* 
// Can U help!
// 1. rest tables with affiliate_id - any manupulation with this tables?? 
affiliate_banners_history
affiliate_clickthroughs
affiliate_payment
affiliate_sales
// 2. and may be cleanup need for deleted affiliate_root = " . $affiliate['affiliate_root'] . " in this if branch
// 3. if (true) {} part not cleanup affiliate data ??
*/
      if ( $affiliate_id!=0 ) {
        tep_db_query("delete from " . TABLE_PRODUCTS_TO_AFFILIATES . " where affiliate_id = '" . $affiliate_id . "'");
        tep_db_query("delete from " . TABLE_CATEGORIES_DESCRIPTION . " where affiliate_id = '" . $affiliate_id . "'");
        tep_db_query("delete from " . TABLE_PRODUCTS_DESCRIPTION . " where affiliate_id = '" . $affiliate_id . "'");
        tep_db_query("delete from " . TABLE_INFORMATION . " where affiliate_id = '" . $affiliate_id . "'");
        if (SEARCH_ENGINE_UNHIDE=='True') tep_db_query("delete from " . TABLE_META_TAGS . " where affiliate_id = '" . $affiliate_id . "'");
        tep_db_query("delete from " . TABLE_INFOBOX_CONFIGURATION . " where affiliate_id = '" . $affiliate_id . "'");
        tep_db_query("delete from " . TABLE_FEATURED . " where affiliate_id = '" . $affiliate_id . "'");
        tep_db_query("delete from " . TABLE_NEWSLETTERS . " where affiliate_id = '" . $affiliate_id . "'");
        tep_db_query("delete from " . TABLE_BANNERS . " where affiliate_id = '" . $affiliate_id . "'");
        tep_db_query("update " . TABLE_CUSTOMERS . " set affiliate_id = 0 where affiliate_id = '" . $affiliate_id . "'");
      }
