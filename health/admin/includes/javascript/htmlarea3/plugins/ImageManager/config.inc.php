 ...
 * @author $Author: max $
 * @version $Id: config.inc.php,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
if (file_exists($dir_ws_includes . 'local/configure.php')) include($dir_ws_includes . 'local/configure.php');
...
ini_set('include_path', $tmp . './includes/javascript/htmlarea3/plugins/ImageManager/Classes:');
/*
...
$IMConfig['base_dir'] = DIR_FS_CATALOG . 'images/';
...
$IMConfig['base_url'] = (($request_type == 'SSL') ? HTTPS_CATALOG_SERVER : HTTP_CATALOG_SERVER) . DIR_WS_CATALOG_IMAGES;
...
*/
define('IMAGE_CLASS', 'GD'); //Originally IM
...
/*
  Maximum number of images allowed to index.

  -1 => read all.
*/
$IMConfig['max_image_count'] = -1;

/*
  Possible values: true, false

  TRUE - Enable Image Manager

  FALSE - Disable ImageManager

*/
$IMConfig['display_image_manager'] = true;
?>