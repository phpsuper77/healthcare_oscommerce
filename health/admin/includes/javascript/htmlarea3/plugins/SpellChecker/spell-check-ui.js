...
//
// $Id: spell-check-ui.js,v 1.1.1.1 2005/12/03 21:36:04 max Exp $
...
/*  var dicts = document.getElementById("v_dictionaries");
...
function finishedSpellChecking() {
	...
	if (dicts) {
		...
		document.getElementById("v_dictionaries").value = document.getElementById("f_dictionary").value; 
	}
};
