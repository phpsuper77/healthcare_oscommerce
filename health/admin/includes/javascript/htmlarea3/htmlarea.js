...
//
// $Id: htmlarea.js,v 1.1.1.1 2005/12/03 21:36:03 max Exp $
...
HTMLArea.loadPlugin = function(pluginName) {
  ...
  document.writeln("<script type='text/javascript' src='" + plugin_file + "'></script>");
  document.writeln("<script type='text/javascript' src='" + plugin_lang + "'></script>");
};
...
HTMLArea.isBlockElement = function(el) {
  ...
  return (el.tagName != null?blockTags.indexOf(" " + el.tagName.toLowerCase() + " ") != -1:false);
};
