<?php
/*
  $Id: phplot.php,v 1.1.1.1 2005/12/03 21:36:03 max Exp $
...
//echo "<br>>>$color_asked " . hexdec(substr($color_asked,1,2)) .' ' . hexdec(substr($color_asked,3,2)) . ' ' . hexdec(substr($color_asked,5,2)) . ' <br>';
				$ret_val =  array(hexdec(substr($color_asked,1,2)), hexdec(substr($color_asked,3,2)), hexdec(substr($color_asked,5,2)));
			} else { 
...
//echo $this->SetIndexColor($col) . " $col <br>";
			$this->ndx_data_color[$i] = $this->SetIndexColor($col);
			$i++;
		}
