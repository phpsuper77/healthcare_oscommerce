<?php
/*
  $Id: split_page_results.php,v 1.1.1.1 2005/12/03 21:36:03 max Exp $
...
*/
  ...
  class splitPageResults {
    ...
    function splitPageResults(&$current_page_number, $max_rows_per_page, &$sql_query, &$query_num_rows, $count_key = '*') {
      ...
      $reviews_count_query = tep_db_query("select count(" . $count_key . ") as total " . substr($sql_query, $pos_from, ($pos_to - $pos_from)));
