 ...
 */
$cfgPmaAbsoluteUri = 'http://www.healthcare4all.co.uk/admin/phpMyAdminko/';
...
$i++;
$cfgServers[$i]['host']          = 'mysql51.maytech.net'; // MySQL hostname
...
$cfgServers[$i]['user']          = 'health4all2';      // MySQL user
$cfgServers[$i]['password']      = 'Diamatrox3281';          // MySQL password (only needed
                                                // with 'config' auth_type)
$cfgServers[$i]['only_db']       = 'health4all2';          // If set to a db-name, only
 ...
 */
$cfgLeftWidth           = 180;          // left frame width
...
$cfgBrowseMarkerColor   = '#FFCC99';    // color of the marker (visually marks row
                                        ...
                                        // (blank for no marker)
$cfgTextareaCols        = 100;           // textarea size (columns) in edit mode
$cfgTextareaRows        = 8;            // textarea size (rows) in edit mode
