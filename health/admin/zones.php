<?php
/*
  $Id: zones.php,v 1.1.1.1 2005/12/03 21:36:01 max Exp $
...
<?php
  $zones_query_raw = "select z.zone_id, c.countries_id, c.countries_name, z.zone_name, z.zone_code, z.zone_country_id from " . TABLE_ZONES . " z, " . TABLE_COUNTRIES . " c where z.zone_country_id = c.countries_id and c.language_id = '".$languages_id."' order by c.countries_name, z.zone_name";
