 ...
 * @return 
 */
	function MaximumUnpaidItemStrikesDurationDetailsType()
	{
		$this->EbatNs_ComplexType('MaximumUnpaidItemStrikesDurationDetailsType', 'urn:ebay:apis:eBLBaseComponents');
