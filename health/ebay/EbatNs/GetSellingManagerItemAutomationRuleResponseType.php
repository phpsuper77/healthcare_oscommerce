 ...
 * @return 
 */
	function GetSellingManagerItemAutomationRuleResponseType()
	{
		$this->AbstractResponseType('GetSellingManagerItemAutomationRuleResponseType', 'urn:ebay:apis:eBLBaseComponents');
