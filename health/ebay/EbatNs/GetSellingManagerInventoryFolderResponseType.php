 ...
 * @return 
 */
	function GetSellingManagerInventoryFolderResponseType()
	{
		$this->AbstractResponseType('GetSellingManagerInventoryFolderResponseType', 'urn:ebay:apis:eBLBaseComponents');
