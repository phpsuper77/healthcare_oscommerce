 ...
 * @return 
 */
	function GetSellingManagerTemplateAutomationRuleResponseType()
	{
		$this->AbstractResponseType('GetSellingManagerTemplateAutomationRuleResponseType', 'urn:ebay:apis:eBLBaseComponents');
