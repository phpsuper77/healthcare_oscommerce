 ...
 * @return 
 */
	function DeleteSellingManagerItemAutomationRuleResponseType()
	{
		$this->AbstractResponseType('DeleteSellingManagerItemAutomationRuleResponseType', 'urn:ebay:apis:eBLBaseComponents');
