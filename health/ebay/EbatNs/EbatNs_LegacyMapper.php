 ...
 * @version $Id: EbatNs_LegacyMapper.php,v 1.1 2007/05/31 11:38:00 michael Exp $
 * @access public 
 */
...
{
	var $_EbatNs_MapTarget;
	var $_EbatNs_MapExpression;
	var $_mapper;
	 ...
	 * @return 
	 */
	function EbatNs_MapMapping(&$mapper, $mapping)
	{
...
class EbatNs_LegacyMapper
{
	 ...
	 * @return 
	 */
	function EbatNs_LegacyMapper($mapping, &$destObject, &$data, &$valueMapString, $defaultData = null)
	{
	...
	{ 
		// echo "_getLocal $key <br>";
		return $t = &$this->_locals[$key];
	} 
	...
	{ 
		// echo "_setTarget $targetName, $value, $isArray , $index <br>";
