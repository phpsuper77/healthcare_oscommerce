 ...
 * @return 
 */
	function SetSellingManagerItemAutomationRuleResponseType()
	{
		$this->AbstractResponseType('SetSellingManagerItemAutomationRuleResponseType', 'urn:ebay:apis:eBLBaseComponents');
