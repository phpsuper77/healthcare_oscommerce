 ...
 * @return 
 */
	function AddItemFromSellingManagerTemplateResponseType()
	{
		$this->AbstractResponseType('AddItemFromSellingManagerTemplateResponseType', 'urn:ebay:apis:eBLBaseComponents');
