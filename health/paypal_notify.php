<?php
/*
  $Id: paypal_notify.php,v 1.1.1.1 2005/12/03 21:36:01 max Exp $
...
// lets start with the email confirmation
        ...
        $email_order = STORE_NAME . "\n" . 
                       ...
                       EMAIL_TEXT_INVOICE_URL . ' ' . tep_get_clickable_link(tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_id=' . $item_number, 'SSL', false)) . "\n" .
        ...
        if ($order->content_type != 'virtual') {
          $email_order .= "\n" . EMAIL_TEXT_DELIVERY_ADDRESS . "\n" . 
                          EMAIL_SEPARATOR . "\n";
          $email_order .= tep_address_format($order->delivery['format_id'], $order->delivery, false, '', "\n") . "\n";
        }

        $email_order .= "\n" . EMAIL_TEXT_BILLING_ADDRESS . "\n" .
                        EMAIL_SEPARATOR . "\n";
        $email_order .= tep_address_format($order->billing['format_id'], $order->billing, false, '', "\n") . "\n\n";
