<?php
/*
  $Id: links_submit.php,v 1.1.1.1 2005/12/03 21:36:01 max Exp $
...
// needs to be included earlier to set the success message in the messageStack
  ...
  if (isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'process')) {
    ...
    if ($error == false) {
      ...
      $categories_query = tep_db_query("select link_categories_id from " . TABLE_LINK_CATEGORIES_DESCRIPTION . " where link_categories_name = '" . tep_db_input($links_category) . "' and language_id = '" . (int)$languages_id . "'");
