<?php
/*
  $Id: affiliate_password_forgotten.php,v 1.1.1.1 2005/12/03 21:36:01 max Exp $
...
*/
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'process')) {
    $check_affiliate_query = tep_db_query("select affiliate_firstname, affiliate_lastname, affiliate_password, affiliate_id from " . TABLE_AFFILIATE . " where affiliate_email_address = '" . tep_db_input($HTTP_POST_VARS['email_address']) . "'");
