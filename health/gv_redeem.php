<?php
/*
  $Id: gv_redeem.php,v 1.1.1.1 2005/12/03 21:36:01 max Exp $
...
// check for a voucher number in the url
  if (isset($HTTP_GET_VARS['gv_no'])) {
    $error = true;
    $gv_query = tep_db_query("select c.coupon_id, c.coupon_amount from " . TABLE_COUPONS . " c, " . TABLE_COUPON_EMAIL_TRACK . " et where coupon_code = '" . tep_db_input($HTTP_GET_VARS['gv_no']) . "' and c.coupon_id = et.coupon_id");
