<?php
/*
  $Id: form_check.js.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
...
<?php if (ACCOUNT_COMPANY_VAT_ID == 'true' && check_customer_groups($group, 'groups_is_reseller')) echo '  check_input("entry_company_vat", ' . ENTRY_VAT_ID_MIN_LENGTH . ', "' . ENTRY_VAT_ID_ERROR . '");' . "\n"; ?>


  check_input("email_address", <?php echo ENTRY_EMAIL_ADDRESS_MIN_LENGTH; ?>, "<?php echo ENTRY_EMAIL_ADDRESS_ERROR; ?>");
  check_input("street_address_line1", <?php echo ENTRY_STREET_ADDRESS_MIN_LENGTH; ?>, "<?php echo ENTRY_STREET_ADDRESS_ERROR; ?>");
