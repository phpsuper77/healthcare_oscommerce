<?php
/*
  $Id: checkout_confirmation.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
...
define('DELIVERY_ADDRESS_TITLE', 'Versand/Produkte informationen');
define('TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Checkout fortsetzen');
