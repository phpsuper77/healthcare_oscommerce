<?php
/*
  $Id: account_history_info.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
...
define('NAVBAR_TITLE_2', 'Bestellte Artikel');
...
define('HEADING_DELIVERY_INFORMATION', 'Versand/Produkte informationen');
