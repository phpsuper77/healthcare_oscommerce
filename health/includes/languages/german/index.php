<?php
/*
  $Id: index.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
...
define('TABLE_HEADING_DEFAULT_SPECIALS', 'Specials f&uuml;r %s');
define('HEADING_CUSTOMER_GREETING', 'Unsere Gl&uuml;ckw&uuml;nsche');
define('MAINPAGE_HEADING_TITLE', 'Startseitentitel');
define('TABLE_HEADING_FEATURED_PRODUCTS', 'Auktionsprodukte');
define('TABLE_HEADING_FEATURED_PRODUCTS_CATEGORY', 'Auktionsprodukte bei %s'); 
define('TEXT_WE_ALSO_RECOMMEND', 'Wir empfehlen Ihnen auch:');
define('TABLE_HEADING_PRODUCT_NAME', 'Produktname');
define('TABLE_HEADING_PRODUCT_PRICE', 'Preis');
define('TEXT_BUY_NOW', 'Jetzt jaufen');
