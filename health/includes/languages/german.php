...
define('BOX_SEARCH_TEXT', 'Verwenden Sie Stichwörter, um ein Produkt zu finden.');
...
define('HEADING_CUSTOMER_GREETING', 'Unsere Glückwünsche an Kunden');
...
define('TEXT_CUSTOMER_GREETING_HEADER', 'Unsere Glückwünsche');
...
// shopping cart quotes
  ...
  if (strstr($PHP_SELF,'shopping_cart.php')) {
    define('SHIPPING_OPTIONS_LOGIN', 'Bitte <a href="' . tep_href_link(FILENAME_LOGIN, '', 'SSL') . '"><u>loggen Sie sich ein</u></a>, um Ihre persönlichen Versandoptionen anzeigen zu können.');
  } else {
    define('SHIPPING_OPTIONS_LOGIN', 'Bitte loggen Sie sich ein, um Ihre persönlichen Versandoptionen anzeigen zu können.');
  }
  ...
  define('ENTRY_VAT_ID_ERROR', 'Europäische USt-ID Fehler.');
