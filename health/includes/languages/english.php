...
define('HEADER_TITLE_CATALOG', 'Catalogue');//'Catalog');
...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date("Y") . ' ' . STORE_NAME . '<br>');
...
// shopping cart quotes
  ...
  define('TEXT_EXCL_VAT', '(excluding VAT)');
  define('TEXT_INCL_VAT', 'including VAT');
  define('TEXT_SHOW_CONTENTS_OF_MY_CART', 'Show contents of my cart');    

  // SEO Reviews
  define('REVIEW_TEXT_FROM_LENGTH', '2');
  define('REVIEW_YOUR_NAME', 'Your name');
  define('JS_REVIEW_CUSTOMER_FULL_NAME', '* The \'' . REVIEW_YOUR_NAME . '\' must have at least ' . REVIEW_TEXT_FROM_LENGTH . ' characters');
 // SEO Reviews
