...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_DP_TEXT_TITLE', 'PayPal Payment');
  define('MODULE_PAYMENT_PAYPAL_EC_TEXT_TITLE', 'PayPal Express Checkout');
  define('MODULE_PAYMENT_PAYPAL_DP_TEXT_DESCRIPTION', '<center><b><h2>PayPal Pro for osCommerce 2.2MS2+</h2>Direct Payment & Express Checkout</center>');
  ...
  define('MODULE_PAYMENT_PAYPAL_EC_ALTERNATIVE', 'PayPal');
