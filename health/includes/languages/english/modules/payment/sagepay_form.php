...
*/
  ...
  define('MODULE_PAYMENT_SAGEPAY_FORM_TEXT_TITLE', 'Credit or Debit Card using secure SagePay');//'Credit Card with Sage Pay');
  define('MODULE_PAYMENT_SAGEPAY_FORM_TEXT_DESCRIPTION', 'Credit Card Test Info:<br><br>See Sagepay Test Cards.txt');
