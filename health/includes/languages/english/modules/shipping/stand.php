...
define('MODULE_SHIPPING_STAND_TEXT_TITLE', 'DPD Next Working Day Courier');
define('MODULE_SHIPPING_STAND_TEXT_DESCRIPTION', 'Zone Based Rates');
define('MODULE_SHIPPING_STAND_TEXT_WAY', 'Estimated delivery time will be emailed by DPD');
