...
define('EMAIL_CONTACT', 'For help with any of our online services, please email the store-owner: ' . tep_get_clickable_link(STORE_OWNER_EMAIL_ADDRESS) . '.' . "\n\n");
define('EMAIL_WARNING', '<b>Note:</b> This email address was given to us by one of our customers. If you did not signup to be a member, please send an email to ' . tep_get_clickable_link(STORE_OWNER_EMAIL_ADDRESS) . '.' . "\n");
