<?php
/*
  $Id: link_listing.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
        ...
        switch ($column_list[$col]) {
          ...
          case 'LINK_LIST_IMAGE':
            ...
            if (tep_not_null($listing['links_image_url'])) {
              ...
              $lc_text = '<a href="' . tep_get_links_url($listing['links_id']) . '" target="_blank">' . tep_image(DIR_WS_TEMPLATE_IMAGES . 'pixel_trans.gif', $listing['links_title'], LINKS_IMAGE_WIDTH, LINKS_IMAGE_HEIGHT, 'style="border: 3px double black"') . '</a>';
            }
            break;
          case 'LINK_LIST_COUNT':
            $lc_align = '';
