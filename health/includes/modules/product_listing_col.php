<?php
/*
  $Id: product_listing_col.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
*/

  $listing_split = new splitPageResults($listing_sql, MAX_DISPLAY_SEARCH_RESULTS, 'p.products_id');
  $product_listing = new product_listing();
  if ($search_results_page) $product_listing->add_no_follow = true; //Musaffar - no follow to search results products
