...
/*
  ...
  http://addons.oscommerce.com/info/441
*/
...
// class methods
    ...
    function before_process() {
      ...
      if ($Status !== true) {
        ...
        $hrefLink = tep_href_link( FILENAME_CHECKOUT_PAYMENT, 'payment_error=' . $this->code . '&error=' . urlencode($StatusDetail), 'SSL', true, false );
