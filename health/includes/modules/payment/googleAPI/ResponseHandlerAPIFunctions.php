...
include_once( (defined('DIR_FS_CATALOG_MODULES')?DIR_FS_CATALOG_MODULES:DIR_WS_MODULES).'payment/googleAPI/'."MerchantCalculationsAPIFunctions.php");
...
function ProcessCheckoutRedirect($dom_response_obj) {
  global $cart;
    ...
    // if we will have error during request we will redirect to checkout_payment page
    $cart->reset(true);
