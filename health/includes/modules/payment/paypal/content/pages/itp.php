<?php
/*
  $Id: itp.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
...
<input type="hidden" name="digest" value="<?php echo paypal::digest(); ?>">
...
<?php } ?>
  <tr>
    <td style="text-align: right;"><?php echo $page->javascriptLink('Help with this page','action=itp-help'); ?>&nbsp;<?php echo $page->javascriptLink($page->image('help.gif','','17','15'),'action=itp-help');?></td>
  </tr>
  <tr>
    <td>
