...
?>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_GENDER; ?></td>
            <td class="main">&nbsp;
<?php
...
?>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_FIRST_NAME; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_LAST_NAME; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_DATE_OF_BIRTH; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_EMAIL_ADDRESS; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_FROM_EMAIL_ADDRESS; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
    echo $affiliate['affiliate_email_from'];
  } elseif ($error == true) {
    if ($entry_from_email_address_error == true) {
      echo tep_draw_input_field('a_from_email_address') . '&nbsp;' . ENTRY_FROM_EMAIL_ADDRESS_ERROR;
    }elseif ($entry_from_email_address_check_error == true) {
      echo tep_draw_input_field('a_from_email_address') . '&nbsp;' . ENTRY_FROM_EMAIL_ADDRESS_CHECK_ERROR;
    }else{
      echo $a_email_address . tep_draw_hidden_field('a_from_email_address');
    }
  } else {
    echo tep_draw_input_field('a_from_email_address', $affiliate['affiliate_email_from']) . '&nbsp;' . ENTRY_FROM_EMAIL_ADDRESS_TEXT;
  }
?>
            </td>
          </tr>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_STORE_NAME; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
      echo $affiliate['affiliate_store_name'];
    } elseif ($error == true) {
      if ($entry_company_error == true) {
        echo tep_draw_input_field('a_store_name') . '&nbsp;' . ENTRY_AFFILIATE_STORE_NAME_ERROR;
      } else {
        echo $a_company . tep_draw_hidden_field('a_store_name');
      }
    } else {
      echo tep_draw_input_field('a_store_name', $affiliate['affiliate_store_name']) . '&nbsp;' . ENTRY_AFFILIATE_STORE_NAME_TEXT;
    }
?>
            </td>
          </tr>
...
?>      
        <table border="0" width="100%" cellspacing="0" cellpadding="1" class="contentBox">
          <tr>
            <td><table border="0" cellspacing="2" cellpadding="2" class="contentBoxContents" width="100%" height="100%"> 
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_COMPANY; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_COMPANY_TAXID; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>  
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_CHECK; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>  
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_PAYPAL; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>  
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_NAME; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_BRANCH_NUMBER; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_SWIFT_CODE; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NAME; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NUMBER; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
        <table border="0" width="100%" cellspacing="0" cellpadding="1" class="contentBox">
          <tr>
            <td><table border="0" cellspacing="2" cellpadding="2" class="contentBoxContents" width="100%" height="100%"> 
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_STREET_ADDRESS; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
    ...
    echo tep_draw_input_field('street_address_line1', $affiliate['affiliate_street_address']) . '&nbsp;' . ENTRY_STREET_ADDRESS_TEXT;
  }
?>
            </td>
          </tr>
...
?>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_SUBURB; ?></td>
            <td class="main">&nbsp;
<?php
    if ($is_read_only == true) {
      ...
      echo tep_draw_input_field('street_address_line2', $affiliate['affiliate_suburb']) . '&nbsp;' . ENTRY_SUBURB_TEXT;
    }
?>
            </td>
          </tr>
...
?>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_POST_CODE; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_CITY; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_STATE; ?></td>
            <td class="main">&nbsp;
<?php
...
?>          
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_COUNTRY; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>    
        <table border="0" width="100%" cellspacing="0" cellpadding="1" class="contentBox">
          <tr>
            <td><table border="0" cellspacing="2" cellpadding="2" class="contentBoxContents" width="100%" height="100%"> 
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_TELEPHONE_NUMBER; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_FAX_NUMBER; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_AFFILIATE_HOMEPAGE; ?></td>
            <td class="main">&nbsp;
<?php
  if ($is_read_only == true) {
...
?> 
        <table border="0" width="100%" cellspacing="0" cellpadding="1" class="contentBox">
          <tr>
            <td><table border="0" cellspacing="2" cellpadding="2" class="contentBoxContents" width="100%" height="100%"> 
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_PASSWORD; ?></td>
            <td class="main">&nbsp;
<?php
    if ($error == true) {
...
?>
          <tr>
            <td class="main" style="width:30%">&nbsp;<?php echo ENTRY_PASSWORD_CONFIRMATION; ?></td>
            <td class="main">&nbsp;
<?php
