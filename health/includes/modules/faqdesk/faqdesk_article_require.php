...
$product = tep_db_query("select faqdesk_question from " . TABLE_FAQDESK_DESCRIPTION . " where language_id = '" . (int)$languages_id . "' and faqdesk_id = '" . (int)$HTTP_GET_VARS['faqdesk_id'] . "'");
...
<?php
$reviews = tep_db_query("select reviews_rating, reviews_id, customers_name, date_added, last_modified, reviews_read from " . TABLE_FAQDESK_REVIEWS . " where approved='1' and faqdesk_id = '" . (int)$HTTP_GET_VARS['faqdesk_id'] . "' order by reviews_id DESC");
