...
pd WHERE pd.faqdesk_id = p.faqdesk_id and pd.language_id = "' . (int)$languages_id . '" and faqdesk_status = 1 and p.faqdesk_sticky = 0 ORDER BY faqdesk_date_added DESC LIMIT ' . MAX_DISPLAY_FAQDESK_FAQS);
