<?php
/*
  $Id: order_total.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
    ...
    function credit_selection() {
      ...
      if (MODULE_ORDER_TOTAL_INSTALLED) {
        ...
        */
        ...
        $info_box_contents[] = array('text' => TABLE_HEADING_CREDIT);
        $box = new contentBoxHeading($info_box_contents, false, false, false, false);
        $header_string .= $box->table;
        $header_string .= '<table border="0" width="100%" cellspacing="1" cellpadding="0" class="contentBox">' . "\n";
        $header_string .= '     <tr><td><table border="0" width="100%" cellspacing="0" cellpadding="2" class="contentBoxContents">' ."\n";
        $header_string .= '       <tr><td width="10">' .  tep_draw_separator('pixel_trans.gif', '10', '1') .'</td>' . "\n";
        $header_string .= '           <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">' . "\n";
        $close_string   = '                           </table></td>';
        $close_string  .= '<td width="10">' .  tep_draw_separator('pixel_trans.gif', '10', '1') . '</td>';
            ...
            if ( ($use_credit_string !='' ) || ($selection_string != '') ) {
              ...
              if ($GLOBALS[$class]->header){
                $output_string = ' <tr class="moduleRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" >' . "\n" .
                               ...
                               '     <td class="main" width="50%"><b>' . $GLOBALS[$class]->header . '</b></td><td class="main">&nbsp;</td>';
