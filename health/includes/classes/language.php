<?php
/*
  $Id: language.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
...
*/
  ...
  class language {
    ...
    function language($lng = '') {
      ...
      $languages_query = tep_db_query("select languages_id, name, code, image, directory  from " . TABLE_LANGUAGES . " where languages_status = 1 order by sort_order");
