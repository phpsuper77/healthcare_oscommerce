<?php
/*
  $Id: banktransfer_validation.php,v 1.1.1.1 2005/12/03 21:36:11 max Exp $
...
// Diese function gibt die Bankinformationen aus der Datenbank zurück*/
  function db_query($blz) {
    $blz_query = tep_db_query("SELECT * from ".TABLE_BANKTRANSFER_BLZ." WHERE blz = '" . tep_db_input($blz) . "'");
    if (tep_db_num_rows($blz_query))
