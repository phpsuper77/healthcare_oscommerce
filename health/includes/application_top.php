...
// }}
	...
	if ($HTTP_GET_VARS['cPath_name'] != "") {
		...
		/* If tyhis is actegory url, simply use the current url in lowercase for the canonical tag */
  ...
  if(basename($PHP_SELF) == FILENAME_DEFAULT && !isset($HTTP_GET_VARS['cPath']))
  {
	...
	/* Canonical tag for info pages */
	/*if ($_GET['info_name'] != "") {
		$canonical = "http://".$_SERVER["SERVER_NAME"]."/".str_replace(" ", "+", $_GET['info_name']);
	}*/
