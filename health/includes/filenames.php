<?php
/*
  $Id: filenames.php,v 1.1.1.1 2005/12/03 21:36:10 max Exp $
...
// Added for Xsell Products Mod
  ...
  define('FILENAME_GIVEAWAY_PRODUCTS', 'giveaway.php');
  define('FILENAME_PROTX_PROCESS', 'protx_process.php');

  define('CONTENT_VATFORM','vatform');
  define('FILENAME_VATFORM', CONTENT_VATFORM.'.php');
